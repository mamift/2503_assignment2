...
--    Document    : F:\DROPBOX\CODE\2503ICT\ASSIGNMENT2\DOCUMENTATION\DATABASEERMODEL+WITHOUT_ATTRIBUTES.VSD.
--    Time Created: 3 February 2013 7:52 PM.
...
drop table if exists a2_Item;
drop table if exists a2_Category;
drop table if exists a2_Bid;
drop table if exists a2_User;
...
-- 	seller_username_id : a2_User selling a2_Item  
create table a2_Item ( 
	id INTEGER not null auto_increment,
	name VARCHAR(255) not null,
	description TEXT not null,
	category_id INTEGER not null,
	starting_price DOUBLE PRECISION(8,2) not null,
	manufacturer VARCHAR(255) not null,
	expiration_date DATETIME null,
	seller_username_id INTEGER not null, constraint a2_Item_PK primary key (id) ); 

-- Create new table a2_Category.
-- a2_Category : Table of a2_Category
-- 	description : Description describes a2_Category
-- 	name : a2_Category has Name
-- 	id : a2_Categoryid identifies a2_Category  
create table a2_Category ( 
	id INTEGER not null auto_increment, constraint a2_Category_PK primary key (id),
	name VARCHAR(255) not null,
	description TEXT not null ); 
...
-- 	description : Description describes a2_User
-- 	password : Password is a key for a2_User
-- 	e_mail : E_mail is for a2_User
-- 	id : a2_Userid identifies a2_User
-- 	type : a2_User has Type  
create table a2_User ( 
	...
	type VARCHAR(255) not null, constraint a2_User_PK primary key (id) ); 
...
-- 	username_id : a2_User places a2_Bid  
create table a2_Bid ( 
	id INTEGER not null auto_increment,
	item_id INTEGER not null,
	amount DOUBLE PRECISION(8,2) not null,
	bid_date DATETIME not null,
	username_id INTEGER not null, constraint a2_Bid_PK primary key (id) ); 
...
ALTER TABLE `s2757691db`.`a2_User` ADD COLUMN `salt` VARCHAR(255) NULL  AFTER `type`, ADD UNIQUE INDEX `salt_UNIQUE` (`salt` ASC) ;
ALTER TABLE `s2757691db`.`a2_User` DROP COLUMN `salt`, DROP INDEX `salt_UNIQUE` ;
